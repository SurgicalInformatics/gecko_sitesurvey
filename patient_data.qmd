...
patient_data = patient_data_orig %>% 
  ...
  mutate(period = if_else(period %in% c("Period 1: 31st Jul - 13th Aug 2023",
                                        ...
                                        "Period 3: 28th Aug - 10th Sept 2023",
                                        "Period 4: 11th Sept - 24th Sept 2023",
                                        "Period 5: 25th Sept - 8th Oct 2023",
                                        "Period 6: 9th Oct - 22nd Oct 2023"), period, "Missing"))
...
```{r}
barplot_count(patient_data, wb, "World bank income group", high_n = 1000)
```

```{r}
barplot_count(patient_data, op_performed, "Operation performed", high_n = 400) +
